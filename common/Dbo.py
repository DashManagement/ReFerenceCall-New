...
class Dbo:
    ...
    async def getNextIdtoUpdate(self, field_name, db='test'):
        ...
        if field_name == 'friend_verify_log' or field_name == 'email_verify' or field_name == 'lp_gp':
            # 组织更新参数
