...
class EmailCaptchaVerify():
    ...
    async def registerVerify(self):
        ...
        logger.info(f"in registerVerify {self.uid}, {self.verify}")
    ...
    async def updateEmailVerifyStatus(self):
        ...
        set_field = {'$set': {'is_verify': '1', 'verify_type': self.verify_type,
                              'verify_time': common.getTime(), 'status': '1'}}
