...
class MeetingFirstMeetingRequest:
    ...
    async def construct(self, id, volunteers_id, request_type, reservation_company_id, reservation_company_name, time_zone_number, time_zone):
        ...
        if is_meeting_result is None:
            ...
            # 添加一条预约信息
            insert_result = await self.insertFirstMeetingRequest(id, volunteers_id, request_type, time_zone_number, time_zone, reservation_company_id, reservation_company_name, company_info['rc_company_icon'], users_info)
    ...
    # 添加第一次预约会议的请求记录
    async def insertFirstMeetingRequest(self, id, volunteers_id, request_type, time_zone_number, time_zone, reservation_company_id, reservation_company_name, company_icon, users_info):
